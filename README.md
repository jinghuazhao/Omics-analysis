...
Additional information is given in [a wiki section](https://github.com/jinghuazhao/Omics-projects/wiki/Resources). Expected to be a long-term project, the site could eventually be enriched by many practitioners.
