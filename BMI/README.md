...
We employ two-sample Mendelian Randomisation analysis using the data with the mega-meta-analysis from DIAGRAM,
```bash
...
END
```
Note the similarity with the BMI-lung cancer example shown in software-notes.
